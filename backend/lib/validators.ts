// Heavily inspired from https://github.com/ctavan/express-validator
// Modified (not completely) to use Typescript syntax
// and call it connectValidator instead of express-validator
...
var additionalSanitizers = ['trim', 'ltrim', 'rtrim', 'escape', 'stripLow',
 ...
 *
 * @method connectValidator
 * @param  {object}         options
 * @return {function}       middleware
 */

export function connectValidator(options) {
  options = options || {};
  var defaults = {
    customValidators: {},
    customSanitizers: {},
  ...
  return function(req, res, next) {
    ...
    req.asyncValidationErrors = function(mapped) {
      return new BB(function(resolve, reject) {
        ...
        BB.settle(promises).then(function(results) {
...
export function formatParamOutput(param) {
